package Lab24;
// Retrieving Record from customers table using XML configuration and the avoided column data will not come from DB bcoz the column it self is not present  
