...
public class Lab6A {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Integer it = (Integer) session.save(stu); // returns the count of DB operation is submitted on same database and same tables
			System.out.println(it.intValue()); // 6 // Count starts from 6, Becoz in XML based we already submitted 5 DB operation to same database and same tables
