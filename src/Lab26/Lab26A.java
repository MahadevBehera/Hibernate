package Lab26;
 // Inserting Record in customers table using XML configuration and Its a example Immutable Objects means the data of the Table we can't modify after insertion once
